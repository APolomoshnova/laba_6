...
def create_plane():
    """Создает авиакомпанию, запрашивая у пользователя название."""
    name = input("Введите авиакомпанию самолета: ")
    return Plane(name)


def create_flight(plane):
    """Создает рейс, запрашивая у пользователя пункт отправления и назначения."""
...
def create_ticket(flight):
    """Создает билет, запрашивая у пользователя имя и место пассажира."""
